...
![Standard Button](svn-assets/screenshot-1.png)

### 2. Live Preview
![Live Preview](svn-assets/screenshot-2.png)

### 3. General Settings
![General Settings](svn-assets/screenshot-3.png)

### 4. Placement Configuration
![Placement Configuration](svn-assets/screenshot-4.png)

### 5. Message Customization
![Message Customization](svn-assets/screenshot-5.png)

### 6. Design Settings - Standard
![Design Standard](svn-assets/screenshot-6.png)

### 7. Design Settings - Compact
![Design Compact](svn-assets/screenshot-7.png)

### 8. WhatsApp Message Output
![WhatsApp Message](svn-assets/screenshot-8.png)

### 9. Compact Button (Frontend)
![Compact Button](svn-assets/screenshot-9.png)
